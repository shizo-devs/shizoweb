...
Baileys and its maintainers cannot be held liable for misuse of this application, as stated in the [MIT license](https://github.com/shizothetechie/shizoweb/blob/master/LICENSE).
...
```
yarn add @shizodevs/shizoweb
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:shizothetechie/shizoweb
```

Then import your code using:
``` ts 
import makeWASocket from '@shizodevs/shizoweb'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@shizodevs/shizoweb'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@shizodevs/shizoweb'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@shizodevs/shizoweb'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@shizodevs/shizoweb'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@shizodevs/shizoweb'
                                */
...
import { downloadMediaMessage } from '@shizodevs/shizoweb'
